...
use crate::sql_types::{BigInt, Bool, BoolOrNullableBool, IntoNullable, Typed};
...
impl<'a, ST, QS, DB> SelectNullableDsl for BoxedSelectStatement<'a, Typed<ST>, QS, DB>
where
    ST: IntoNullable,
{
    type Output = BoxedSelectStatement<'a, Typed<ST::Nullable>, QS, DB>;
