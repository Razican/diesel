macro_rules! generic_numeric_expr_inner {
    ($tpe: ident, ($($param: ident),*), $op: ident, $fn_name: ident) => {
        impl<Rhs, $($param),*> ::std::ops::$op<Rhs> for $tpe<$($param),*> where
            ...
            <$tpe<$($param),*> as $crate::Expression>::SqlType: $crate::sql_types::TypedSql,
            <<$tpe<$($param),*> as $crate::Expression>::SqlType as $crate::sql_types::TypedSql>::Inner:
                $crate::sql_types::ops::$op,
            Rhs: $crate::expression::AsExpression<
                <<<$tpe<$($param),*> as $crate::Expression>::SqlType as $crate::sql_types::TypedSql>::Inner as $crate::sql_types::ops::$op>::Rhs,
            >,
        {
